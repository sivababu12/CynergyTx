...
public class Cart_Adapter extends RecyclerView.Adapter<Cart_Adapter.ViewHolder> {
    Context context;
    String filepath, uname = "", emailid = "", phonenum = "", sdate = "", compynyname = "", gstNo = "", edate = "",deleteid="", seates = "", authtoken, cartid = "", booktitle = "",booktype="";
    ...
    public static ArrayList<String> cartlist2=new ArrayList<>();
    ...
    Cart_Adapter cart_adapter=this;
    private final int SINGLE_VIEW = 1;
    ShowDialog dialog;
    public Cart_Adapter(Context context, ArrayList<CartModel> cartModels, String cartType) {
      ...
      //  Log.e("cartid", model.getPrice()+","+model.getSlots());
        ...
        holder.imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                booktype=model.getProduct_name();
                showPopupMenu(view, cartid,booktitle,deleteid,booktype);
...
//                cartlist.add(model.getCart_id());
//                model.setS_flag("0");
//              //  Log.e("addednumber", cartlist.size()+"...."+"0");
//            }else {
//                cartlist.remove(model.getCart_id());
//                model.setS_flag("1");
...
//                        cartlist.remove(model.getCart_id());
                  ...
                  //  Log.e("testtttttttttt", String.valueOf(model.getCart_id()));
    ...
    private void showPopupMenu(View view, String cartid, String booktitle, String deleteid, String productName) {
      //  Log.e("carttt",cartid);
        ...
        switch (item.getItemId()) {
            case R.id.edit_menu:
              //  OpenPopup(cartid,booktitle,booktype);

                if(booktitle.equals("CR")){
                    Intent i = new Intent(context, PracticeActivity.class);
                    i.putExtra("book_model", booktitle);
                    i.putExtra("book_id", cartid);
                    i.putExtra("book_title", booktype);
                    i.putExtra("page", "cart");
                    context.startActivity(i);
                } else if(booktitle.equals("cluster")){
                    openpopup.OpenPopup(cartid,cartid,booktitle);
                }
                else if (booktitle.equals("WS") || booktitle.equals("MC")) {
                    ...
                    openpopup.Popup(cartid, booktitle, booktype, apiSucessResponse);
                   // Log.e("carttt", cartid + "=" + booktype);
                }
                return true;
            case R.id.del_menu:
                Log.d("cartttt", "onMenuItemClick: action_popup_delete @ " + cart_adapter.cartid);
                if (helperClass.checkInternetConnection(context)) {
                    dialog.ShowExitPopup("Are You sure you want to Delete ?", deleteid);
                }else {
    ...
    private void OpenPopup(String cartid, String booktitle,String bookname) {
